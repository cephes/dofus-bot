...
# Fix all files that follow the same pattern as AksQuickPong
...
for rust_file in generated_dir.rglob("*.rs"):
    try:
        ...
        # Check if this file has the same pattern as AksQuickPong
        if '// This Go message is struct{}}; payload is expected to be empty.' in content:
            # Get the struct name
