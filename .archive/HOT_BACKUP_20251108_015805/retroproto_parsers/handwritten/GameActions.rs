...
pub fn route_game_action(action_code: i64, rest: &str) -> Result<serde_json::Value, String> {
    match action_code {
        1 => {
            // Movement action
            match crate::retroproto_parsers::generated::actions::parse_GameAction_1(rest) {
        ...
        2 => {
            // LoadGameMap action
            match crate::retroproto_parsers::generated::actions::parse_GameAction_2(rest) {
                Ok(parsed) => Ok(serde_json::to_value(parsed).unwrap()),
        ...
        900 => {
            // Challenge action
            match crate::retroproto_parsers::generated::actions::parse_GameAction_900(rest) {
                Ok(parsed) => Ok(serde_json::to_value(parsed).unwrap()),
        ...
        901 => {
            ...
            match crate::retroproto_parsers::generated::actions::parse_GameAction_901(rest) {
                Ok(parsed) => Ok(serde_json::to_value(parsed).unwrap()),
        ...
        902 => {
            ...
            match crate::retroproto_parsers::generated::actions::parse_GameAction_902(rest) {
                Ok(parsed) => Ok(serde_json::to_value(parsed).unwrap()),
        ...
        903 => {
            ...
            match crate::retroproto_parsers::generated::actions::parse_GameAction_903(rest) {
                Ok(parsed) => Ok(serde_json::to_value(parsed).unwrap()),
