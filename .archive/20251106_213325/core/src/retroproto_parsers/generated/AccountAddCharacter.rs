...
pub fn parse_account_add_character(payload: &str) -> Result<AccountAddCharacter, String> {
...
pub fn account_add_character_to_json(m: &AccountAddCharacter) -> Value { json!(m) }