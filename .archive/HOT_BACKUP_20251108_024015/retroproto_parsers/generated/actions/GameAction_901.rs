// AUTO-GENERATED GameAction subparser for action code 901
// Source: GameActionsActionChallengeAccept from Go definitions
...
pub fn parse_GameAction_901(payload: &str) -> Result<GameAction_901, String> {
    let parts: Vec<&str> = payload.split(';').collect();
    let mut m = GameAction_901::default();
